...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NOT_1609_CERT), "not 1609 cert"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SEC_ENT_CONNECT_FAILED),
    "sec ent connect failed"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SOCKET_ALLOC_FAILED),
    "socket alloc failed"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SOCKET_ALREADY_INITIALIZED),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNSUPPORTED_CERT_TYPE),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNSUPPORTED_SRV_CERT_TYPE),
    "unsupported srv cert type"},
